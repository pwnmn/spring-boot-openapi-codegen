...
import com.github.pwnmn.client.petstore.model.ModelApiResponse;
...
public interface PetApi {
    ...
    ResponseEntity<Pet> addPet(@ApiParam(value = "Create a new pet in the store" ,required=true )  @Valid @RequestBody Pet pet);
    ...
    ResponseEntity<List<Pet>> findPetsByStatus(@ApiParam(value = "Status values that need to be considered for filter", allowableValues = "available, pending, sold", defaultValue = "available") @Valid @RequestParam(value = "status", required = false, defaultValue="available") String status);
    ...
    ResponseEntity<Pet> updatePet(@ApiParam(value = "Update an existent pet in the store" ,required=true )  @Valid @RequestBody Pet pet);
    ...
    ResponseEntity<ModelApiResponse> uploadFile(@ApiParam(value = "ID of pet to update",required=true) @PathVariable("petId") Long petId,@ApiParam(value = "Additional Metadata") @Valid @RequestParam(value = "additionalMetadata", required = false) String additionalMetadata,@ApiParam(value = ""  )  @Valid @RequestBody(required = false) Resource body);
